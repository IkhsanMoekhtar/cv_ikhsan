...
\begin{tabularx}{\linewidth}{L r}
  ...
  Computer Engineering (Internet Of Things) & \href{https://www.linkedin.com/in/\linkedin}{linkedin.com/in/\linkedin} \\
...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}p{8cm}|>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{2.5cm}|}
  ...
  \hline
  S.T., Teknik Komputer & Institut Teknologi Sepuluh Nopember, Surabaya & 3.33/4.0 & Sep 2025 \\ 
  \hline
\end{tabularx}
\vspace{-4mm}
...
\resumeHeadingSkillStart
    ...
    \resumeSubItem{Editing}{: Adobe Photoshop, Adobe Premiere, Adobe Aftereffect, Capcut, Davinci Resolve}
    \resumeSubItem{Drone Pilot}{: DJI Mini 5 Pro, DJI Phantom 3}
...
\resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItemSub{Led a team of seven (7) to develop \textbf{EdukaOne}, a mobile application designed to help students learn in a structured way and provide learning materials using AI Chatbot.}

        \resumeItemMain{\textbf{Mobile Application Development with Kotlin}}
        \resumeItemSub{Engineered a robust mobile application using Kotlin, reducing API response time to under 200ms through optimized JSON parsing and ensuring 100\% data consistency across real-time user sessions.}
    \resumeItemListEnd
...
\resumeProject
    {Yorio PDF : Protytpe of PDF Processing Platform}
    {Tools: Node.js, JavaScript, React.js, Vite, Hugging Face Space, Vercel}
    {Jan 2026 - Apr 2026}
    {}
\resumeItemListStart
    \resumeItemMain{A web-based PDF editor that allows users to upload, edit, and save PDF files easily.}
    \resumeItemMain{Built with Node.js for the backend and React.js for the frontend; due to limited hosting budget, I deployed the backend on Hugging Face Space and the frontend on Vercel to maintain reliable performance at minimal cost.}
    \resumeItemMain{This project is independent and non-profit, and remains 100\% free, with the goal of providing an accessible and efficient PDF editing solution. Yorio PDF is available at \href{https://pdf-editor-delta-ten.vercel.app/}{Yorio-PDF}.}
\resumeItemListEnd
...
{Sep 2024 - Dec 2024}{}
\resumeItemListStart
    \resumeItemMain{Developed an AI-powered futsal match analysis system that provides statistics and insights, enhancing player performance and game strategy with over 90\% accuracy in player detection using computer vision techniques and LLM(Large Language Models).}
...
\resumeItemListStart
    ...
    \resumeItemMain{Create a system that allows ECG raw data or .SCP type data to be stored on a webpage designed to take over 1000 user at a time without latency and visualized in mobile application using Flutter framework with average data accuracy over 93\%.}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-8mm}
